...
namespace PraxisNote.Infrastructure.Migrations
{
    ...
    [Migration("20260327022017_AddUserAiKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.ApiKeys.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.BlindSpotNudges.BlindSpotNudge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BlindSpotDescription")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<Guid?>("ConvertedGoalId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BlindSpotNudges", (string)null);
                });
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.DriveConnections.DriveConnection", b =>
                {
                    ...
                    b.Property<int>("LastSyncFilesDiscovered")
                        .HasColumnType("integer");

                    b.Property<int>("LastSyncFilesErrored")
                        .HasColumnType("integer");

                    b.Property<int>("LastSyncFilesImported")
                        .HasColumnType("integer");

                    b.Property<int>("LastSyncFilesPendingReview")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.DriveFileImports.DriveFileImport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("DriveConnectionId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DuplicateMatchTitle")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<int>("DuplicateType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<DateTimeOffset>("FileModifiedTime")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("MatchedMeetingId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DriveConnectionId", "DriveFileId")
                        .IsUnique();

                    b.HasIndex("DriveConnectionId", "Status");

                    b.ToTable("DriveFileImports");
                });
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.Meetings.Meeting", b =>
                {
                    ...
                    b.Property<bool>("ExcludeFromInsights")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.Users.AccountLinkCode", b =>
                {
                    ...
                    b.ToTable("AccountLinkCodes", (string)null);
                });
            ...
            modelBuilder.Entity("PraxisNote.Domain.Aggregates.Users.LinkedIdentity", b =>
                {
                    ...
                    b.ToTable("LinkedIdentities", (string)null);
                });

...
export class NotificationPanelComponent {
  ...
  protected getTypeColor(type: string): string {
    switch (type) {
      case 'Feature': return 'bg-feature text-feature-foreground';
      case 'BugFix': return 'bg-bugfix text-bugfix-foreground';
      case 'Improvement': return 'bg-improvement text-improvement-foreground';
      default: return 'bg-surface-muted text-foreground-muted';
    }
  }

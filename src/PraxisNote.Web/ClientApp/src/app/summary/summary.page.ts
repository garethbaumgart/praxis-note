    ...
    <div class="max-w-6xl mx-auto px-6 md:px-8 py-8 md:py-10">
      ...
      <div class="flex items-center justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
          <button
            class="w-9 h-9 flex items-center justify-center rounded-lg border border-border bg-surface-subtle text-foreground-muted hover:bg-surface-muted hover:text-foreground-secondary transition cursor-pointer touch-target"
          ...
          <button
            class="w-9 h-9 flex items-center justify-center rounded-lg border border-border bg-surface-subtle text-foreground-muted hover:bg-surface-muted hover:text-foreground-secondary transition cursor-pointer disabled:opacity-30 disabled:pointer-events-none touch-target"
